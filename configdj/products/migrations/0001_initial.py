# Generated by Django 3.2.19 on 2023-05-24 06:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('UZS', 'UZS'), ('RUB', 'RUB'), ('USD', 'USD')], default='UZS', max_length=3, verbose_name='Valyuta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address', models.CharField(max_length=500, verbose_name='Foydalanuvchi manzili')),
                ('accessory', models.ManyToManyField(default=None, null=True, to='products.Accessory')),
                ('computer', models.ManyToManyField(default=None, null=True, to='products.Computer')),
                ('otherproducts', models.ManyToManyField(default=None, null=True, to='products.Otherproducts')),
                ('smartphone', models.ManyToManyField(default=None, null=True, to='products.Smartphone')),
                ('smartwatch', models.ManyToManyField(default=None, null=True, to='products.Smartwatch')),
        ...
        migrations.AddField(
            ...
            name='firma',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.firma', verbose_name='Firma'),
        ),
    ]
